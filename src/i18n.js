  ...
  en: {
    translation: {
      ...
      game: {
        ...
        drawOne: 'Draw 1',
        drawThree: 'Draw 3',
        drawOneHint: 'Draw one card at a time',
        drawThreeHint: 'Draw three cards at a time',
...
es: {
    translation: {
      ...
      game: {
        ...
        drawOne: 'Sacar 1',
        drawThree: 'Sacar 3',
        drawOneHint: 'Sacar una carta por vez',
        drawThreeHint: 'Sacar tres cartas por vez',
...
fr: {
    translation: {
      ...
      game: {
        ...
        drawOneHint: 'Tirer une carte à la fois',
        drawThreeHint: 'Tirer trois cartes à la fois',
...
it: {
    translation: {
      ...
      game: {
        ...
        drawOne: 'Pesca 1',
        drawThree: 'Pesca 3',
        drawOneHint: 'Pesca una carta alla volta',
        drawThreeHint: 'Pesca tre carte alla volta',
...
pl: {
    translation: {
      ...
      game: {
        ...
        drawOne: 'Dobór 1',
        drawThree: 'Dobór 3',
        drawOneHint: 'Dobierz jedną kartę na raz',
        drawThreeHint: 'Dobierz trzy karty na raz',
...
de: {
    translation: {
      ...
      game: {
        ...
        drawOne: '1 Karte',
        drawThree: '3 Karten',
        drawOneHint: 'Eine Karte auf einmal ziehen',
        drawThreeHint: 'Drei Karten auf einmal ziehen',
