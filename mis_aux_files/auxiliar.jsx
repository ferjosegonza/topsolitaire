...
te paso varias consultas ennumeradas:
1. ejecuté esto:
$ npm install use-sound

added 3 packages, and audited 746 packages in 8s
...
2. recuerda que tienes que ser específico, dónde va esto? handleStockClick, tryMoveToTableau, tryMoveToFoundation? está bien así?
```
